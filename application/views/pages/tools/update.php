  ...
  <div class="alert alert-success"><strong>Congrats!</strong> You're currently running the latest version of the Store Control Panel.</div>
  <p>Your Version: 1.0.0-ALPHA<br>
    Current Version: <strong>1.0.0-ALPHA </strong></p>
  <h3>Store Plugin</h3>
